...
export default function Footer() {
  return (
    <footer className="footer">
      <div className="footer-content"><p>仅供估算</p></div>
      <details className="disclosure" id="policy-notes">
        <summary>政策与隐私说明</summary>
        <p className="help">仅供薪酬估算与比较，不替代工资单或纳税申报。</p>
        ...
        <h3 className="section-label">隐私、保存与备份</h3>
        <p className="help">本地计算 · 无账号 · 薪资和方案不上传服务器</p>
        <p className="help">金额与方案保存在此设备的浏览器 localStorage 中；清理站点数据、使用无痕模式或浏览器限制存储可能导致数据丢失。可通过方案区导出 JSON 备份，导入只在本地解析。</p>
        <p className="help">页面不加载第三方字体或统计脚本；主动打开政策链接会访问外部网站，但不会附带你的薪资参数。不要在共享设备保留敏感薪资，导出文件也需妥善保管。</p>
      </details>
    </footer>
  );
}
