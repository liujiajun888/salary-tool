...
export default function InsuranceCard({ result }: { result: AnnualResult }) {
  ...
  return (
    <section className="panel" aria-labelledby={headingId}>
      <div className="panel-heading"><h2 id={headingId}>社保与公积金</h2></div>
        <p className="help">社保基数 ¥{formatMoney(result.socialBase)} · 公积金基数 ¥{formatMoney(result.hfBase)}</p>
      ...
      <details className="disclosure"><summary>缴费与扣税说明</summary>
        <p className="help">单位工伤采用典型费率，单位公积金按与个人相同比例估算。</p>
